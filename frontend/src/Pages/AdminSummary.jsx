...
export default function AdminSummary() {
      ...
      const mockData = [
        {
          ...
          date: "2025-05-01",
          sentiment: "positive",
          comment: "Great teaching methods!",
        },
        {
          id: 2,
          rating: 2,
          ...
          date: "2025-05-03",
          sentiment: "negative",
          comment: "Difficult to follow lectures.",
        },
        {
          id: 3,
          rating: 5,
          ...
          date: "2025-05-10",
          sentiment: "positive",
          comment: "Excellent resources provided.",
        },
        {
          id: 4,
          rating: 3,
        ...
        },
        {
          ...
          date: "2025-05-20",
          sentiment: "negative",
          comment: "Lectures were not engaging.",
        },
        {
          id: 6,
          rating: 4,
        ...
        },
        {
          ...
          date: "2025-06-01",
          sentiment: "positive",
          comment: "Excellent lab sessions.",
        },
        {
          id: 8,
          rating: 2,
          ...
          date: "2025-06-05",
          sentiment: "negative",
          comment: "Need more hands-on activities.",
        },
      ];
  ...
  const sentimentData = [
    {
      name: "Positive",
      value: filteredData.filter((item) => item.sentiment === "positive")
        .length,
    },
    {
      name: "Neutral",
    ...
    {
      name: "Negative",
      value: filteredData.filter((item) => item.sentiment === "negative")
        .length,
    },
  ];
  ...
  const ratingData = [
    {
      name: "5 Stars",
      value: filteredData.filter((item) => item.rating === 5).length,
    },
    {
      name: "4 Stars",
      value: filteredData.filter((item) => item.rating === 4).length,
    },
    {
      name: "3 Stars",
      value: filteredData.filter((item) => item.rating === 3).length,
    },
    {
      name: "2 Stars",
      value: filteredData.filter((item) => item.rating === 2).length,
    },
    {
      name: "1 Star",
      value: filteredData.filter((item) => item.rating === 1).length,
    },
  ];
